...
interface ProjectSidebarProps {
  ...
  onOpenProject(): Promise<void>; onCreateConversation(): void; onSelectProject(id: string): void; onSelectConversation(id: string): void; onOpenSettings(): void;
